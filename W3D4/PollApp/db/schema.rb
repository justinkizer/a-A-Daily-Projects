...
ActiveRecord::Schema.define(version: 20170209223857) do
  ...
  add_index "responses", ["questioner_id", "respondent_id"], name: "index_responses_on_questioner_id_and_respondent_id", using: :btree
